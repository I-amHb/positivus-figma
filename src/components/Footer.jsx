...
const Footer = () => {
  return (
    <footer className='mt-padding-md lg:mx-padding-lg '>
      <div className='w-full pt-padding-md px-padding-sm lg:px-padding-md bg-secondary text-white lg:rounded-t-4xl'>
        <div className='footer-header lg:flex lg:justify-between lg:items-center '>
          <div className='w-full flex justify-center items-center gap-2 
          lg:justify-normal lg:w-auto'>
            <div><svg width="26px" height="26px" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_3135_135)"><path d="M14.7573 4.45854L29.1886 0.28125L24.9778 14.5001L29.1886 28.6788L14.7573 24.5416L0.285156 28.6788L4.53687 14.5001L0.285156 0.28125L14.7573 4.45854Z" fill="white" /></g><defs><clipPath id="clip0_3135_135"><rect width="29.5167" height="29" fill="white" /></clipPath></defs></svg></div>
          ...
          [&>li]:text-center [&>li]:mt-[18px] lg:[&>li]:mt-0
          lg:flex-row gap-3 lg:[&>li]:min-w-[90px] '>
          ...
          <div className="socials-list hidden gap-3 justify-center items-center mt-5 lg:flex lg:items-center lg:mt-0">
            <a href='#' className='linkedIn '>
              <svg className='w-9 h-9 fill-current text-white hover:text-primary transition-all duration-500 delay  -100 ' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	...
	"/>
            ...
            <a href='#' className='facebook '>
              <svg className='w-9 h-9 fill-current text-white hover:text-primary transition-all duration-500 delay-100   ' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
	...
	c12-2.4,23.2-6.7,33.4-12.8c-3.9,12.3-12.3,22.6-23.1,29.1c10.6-1.3,20.8-4.1,30.2-8.3C234.4,344.5,225.5,353.7,215.2,361.2z"/>
        ...
        <div className="footer-contact mt-9  lg:flex lg:items-center ">
          <div className='[&>p]:text-center [&>p]:mt-2 lg:[&>p]:text-start lg:w-1/2 lg:items-center'>
            <h1 className=' text-center lg:text-start'><span className='px-2 rounded text-black font-bold bg-primary text-center'>Contact us:</span></h1>
	...
	c12-2.4,23.2-6.7,33.4-12.8c-3.9,12.3-12.3,22.6-23.1,29.1c10.6-1.3,20.8-4.1,30.2-8.3C234.4,344.5,225.5,353.7,215.2,361.2z"/>
        ...
        <div className='py-5 border-t mt-7 lg:w-full lg:flex lg:[&>p]:text-start lg:gap-4 '>
          <p className='text-center '>&copy; 2024 Positivus. All rights reserved.</p>
