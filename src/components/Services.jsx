...
const Services = () => {
  return (
    <section className='px-padding-sm lg:px-padding-lg '>
      ...
      [&>div]:border-2 [&>div]:border-b-7 [&>div]:mt-padding-sm [&>div]:h-auto [&>div]:rounded-4xl'>
        <div className='p-8 flex bg-tertiary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-primary min-w-[200px] '>Search engine optimization</span></h1>
        ...
        <div className='p-8 flex bg-primary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-white min-w-[200px] '>Pay-per-click advertising</span></h1>
            <div className='flex items-center gap-4'>
              <div className='w-10 flex  items-center'><img src="/link-Icon.png" alt="link arrow" /></div>
              <a href="#">Learn more</a>
            </div>
        ...
        <div className='p-8 flex bg-secondary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-primary min-w-[200px] '>Social Media Marketing</span></h1>
            <div className='flex items-center gap-4'>
        ...
        <div className='p-8 flex bg-tertiary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-primary min-w-[200px] '>Email Marketing</span></h1>
            <div className='flex items-center gap-4'>
              <div className='w-10 flex  items-center'><img src="/link-Icon.png" alt="link arrow" /></div>
              <a href="#">Learn more</a>
            </div>
        ...
        <div className='p-8 flex bg-primary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-white min-w-[200px] '>Content Creation</span></h1>
            <div className='flex items-center gap-4'>
              <div className='w-10 flex  items-center'><img src="/link-Icon.png" alt="link arrow" /></div>
              <a href="#">Learn more</a>
            </div>
        ...
        <div className='p-8 flex bg-secondary'>
          <div className=' flex flex-col justify-between gap-20 min-w-1/2'>
            <h1 className=' bg-inherit '><span className=' text-mid font-medium text-left bg-primary min-w-[200px] '>Analytic and Tracking</span></h1>
            <div className='flex items-center gap-4'>
              <div className='w-10 flex  items-center'><img src="/link-Icon2.png" alt="link arrow" /></div>
              <a className='text-white' href="#">Learn more</a>
            </div>
      ...
      <div className='bg-tertiary my-padding-lg rounded-4xl p-8'>
        <div>
          <h1 className='text-mid font-medium'>Let's make things happen</h1>
          <p className='mt-5'>Contact us today to learn about how our digital marketing services can help your business grow and succeed online.</p>
