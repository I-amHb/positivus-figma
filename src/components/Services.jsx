  ...
  return (
    <section className='px-padding-sm lg:px-padding-lg '>
      <div className='mt-16 flex flex-col justify-center gap-5 lg:gap-8 items-center lg:flex-row lg:justify-start'>
        <h1><span className='px-2 rounded text-lar font-bold bg-primary text-center'>Services</span></h1>
        <p className='text-center max-w-[550px] lg:text-left'>At our digital marketing agency, we 
